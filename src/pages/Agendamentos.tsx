      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 dark:from-blue-400 dark:via-purple-400 dark:to-blue-500 bg-clip-text text-transparent">Agendamentos</h1>
              <p className="text-slate-600 dark:text-slate-400">Gerencie a agenda de serviços com visualização interativa</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl shadow-lg hover:shadow-purple-500/20 transition-all duration-300">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-slate-900 dark:text-white">{totalAppointments}</div>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Agendamentos</p>
            </CardContent>
          </Card>

          <Card className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl shadow-lg hover:shadow-orange-500/20 transition-all duration-300">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium flex items-center gap-2 text-slate-700 dark:text-slate-300">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-slate-900 dark:text-white">{pendingAppointments}</div>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Aguardando confirmação</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl shadow-lg hover:shadow-emerald-500/20 transition-all duration-300">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-slate-900 dark:text-white">{confirmedAppointments}</div>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Confirmados</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl shadow-lg hover:shadow-blue-500/20 transition-all duration-300">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-slate-900 dark:text-white">{completedAppointments}</div>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Finalizados</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl p-1 rounded-xl">
            <TabsTrigger
              value="calendar"
              className="flex items-center gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-purple-500/50 rounded-lg transition-all text-slate-700 dark:text-slate-300"
            >
          ...
          <TabsContent value="list" className="space-y-4">
            ...
            {searchConfig.isFiltered && (
              <div className="flex items-center justify-between bg-blue-100 dark:bg-blue-500/10 border border-blue-300 dark:border-blue-500/30 rounded-lg p-3 backdrop-blur-sm">
                ...
                <Button
                  ...
                  className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-500/20"
                >
                  Limpar filtros
                </Button>
              </div>
