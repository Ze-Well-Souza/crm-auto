...
-- Add security barrier to prevent data leakage and ensure proper access control
ALTER VIEW public.parceiro_estatisticas SET (security_barrier = true);

-- 3. Add security barrier to monitoring views to prevent unauthorized access
