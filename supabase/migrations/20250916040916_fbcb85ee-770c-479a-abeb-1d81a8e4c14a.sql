...
service_data AS (
  ...
  FROM (
    ...
    (6, 'Troca de correia dentada + bomba d agua', 200.00, 320.00, 0, 'em_andamento', 'Serviço em andamento. Previsão de conclusão amanhã.', '2024-09-16 08:00:00'::timestamp, NULL, NULL),
